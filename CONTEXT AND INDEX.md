...
- **receipts-design.html**: derived. The "ledger" restyle of the app, generated from `receipts.html` by `_build/make-design.py`; never edit it by hand. Same logic and data as the live app, published at `/receipts/design/` for side-by-side comparison. Add `?demo` to either address for isolated sample data.
